using Isrotel.Domain.Optima.Models.Availability;
using Isrotel.Domain.Optima.Models.Customer;
using Isrotel.Domain.Optima.Models.Main;
using Isrotel.Domain.Optima.Models.Umbraco;
...
using Isrotel.Framework.Validation;
...
namespace Isrotel.Framework.StaticData.DbContext
{
    /// <summary> 
