...
using Isrotel.Framework.Middleware;
using Isrotel.Framework.Models;
using Isrotel.Framework.Models.Base;
using Isrotel.Framework.Repositoty;
using Isrotel.Framework.Services;
using Isrotel.Framework.StaticData.Confiuration;
using Isrotel.Framework.StaticData.Contracts;
using Isrotel.Framework.StaticData.DbContext;
using Isrotel.Framework.StaticData.Middleware;
...
namespace Isrotel.Framework.StaticData.Extensions
{
